    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        try (PDDocument doc = new PDDocument()) {
            ...
            try (PDPageContentStream cs = new PDPageContentStream(doc, coverPage)) {
             ...
             // ===== 全面背景 =====
                drawFilledRoundRect(cs, 0, 0, w, h, 248, 244, 238);
                ...
                drawBorderRect(cs, cardM, cardM, cardW, cardH, 210, 200, 190, 1.2f);
                ...
                drawText(cs, font, 36, cardM + 60, h - 160, title, 40, 40, 40);

                // ===== サブタイトル =====
                drawText(cs, font, 16, cardM + 62, h - 200,
                        payload.tripDays + "日間の旅プラン", 120, 120, 120);

                // ===== 区切り線 =====
                cs.setStrokingColor(200, 190, 180);
                cs.setLineWidth(1.2f);
                cs.moveTo(cardM + 60, h - 220);
                cs.lineTo(w - cardM - 60, h - 220);
                cs.stroke();
                ...
                if (map != null) {
                    ...
                    float cx = w / 2 - dw / 2;
                    float cy = h / 2 - dh / 2 - 40;

                    cs.drawImage(map, cx, cy, dw, dh);
                }

                // ===== フッター =====
                drawText(cs, font, 12, w / 2 - 60, cardM + 30, "Generated by Benibanabi", 160, 160, 160);
