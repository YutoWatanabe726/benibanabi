    ...
    <c:param name="content">
        ...
        <div class="container mt-4">
            ...
            <div class="top-actions">
                <a href="AdminSpotCreate.action" class="btn-create">新規作成</a>
            ...
            <div class="search-box">
                <form action="${pageContext.request.contextPath}/benibanabi/main/AdminSpotList.action"
                      method="get">
                    <input type="text"
                           name="keyword"
                        ...
                        <tbody>
                            <c:forEach var="s" items="${spotList}">
                                <tr>
                                    ...
                                    <td>${s.area}</td>
                                    <td>
                                        <a href="AdminSpotUpdate.action?id=${s.spotId}"
                                           class="btn btn-sm btn-primary">編集</a>
                                        <a href="AdminSpotDelete.action?spotId=${s.spotId}&spotName=${s.spotName}&area=${s.area}"
